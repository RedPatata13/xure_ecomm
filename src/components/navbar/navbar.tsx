        ...
        <div className="flex flex-col">
            <div className="flex items-center justify-between w-full px-8 py-4 md:px-12 lg:px-24">
                ...
                <div className="hidden md:flex flex-row gap-3">
                    ...
                    <NavBarItem target="#footer" onClick={scrollToFooter}>Contact</NavBarItem>
            ...
            >
                <div className="min-h-0 flex flex-col px-8 gap-4 border-b border-gray-200 transition-all duration-300 ease-in-out"
                    style={{ paddingTop: menuOpen ? "1rem" : 0, paddingBottom: menuOpen ? "1rem" : 0 }}
                >
                    <NavBarItem target="/" onClick={() => setMenuOpen(false)}>Home</NavBarItem>
                    <NavBarItem target="#footer" onClick={scrollToFooter}>Contact</NavBarItem>
                    <NavBarItem onClick={() => setMenuOpen(false)}>About</NavBarItem>
                    <NavBarItem target="/signup" onClick={() => setMenuOpen(false)}>Sign Up</NavBarItem>
                </div>
            </div>
        </div>
    )
