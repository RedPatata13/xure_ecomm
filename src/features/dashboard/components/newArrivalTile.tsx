...
export default function NewArrivalTile({ productName, productDesc, imagePath, onShopNow, className }: NewArrivalTileProps) {
    return (
        <div className={`relative w-full h-80 bg-black rounded-md overflow-hidden ${className}`}>
