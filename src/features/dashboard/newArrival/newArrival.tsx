      ...
      <div className="flex flex-col lg:flex-row gap-4 md:h-150">
        ...
        <div className="flex flex-col gap-4 lg:flex-1">
          <NewArrivalTile
            ...
            className="w-full h-56 lg:h-1/2"
          />

          <div className="flex gap-4 h-40 lg:h-1/2">
            <NewArrivalTile
