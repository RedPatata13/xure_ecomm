    ...
    if (status === "success") {
        return (
            <div className="flex flex-col items-center gap-3 w-full max-w-sm text-center">
                ...
                <p className="text-gray-500 text-sm">Welcome aboard. You can now log in to your account.</p>
                <a href="/login" className="mt-2 text-sm text-[#DB4444] hover:underline" onClick={clearUser}>Go to login</a>
            </div>
        )
    }
            ...
            <div className="flex flex-col gap-3">
                ...
                </Button>
                {
                    ...
                    ?   <p className="text-sm text-center">
                        ...
                        <a href="/login" className="text-[#DB4444] hover:underline">Log in</a>
                    </p>
                    : <></>
                }
            </div>
